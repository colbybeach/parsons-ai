...
Parsons separately records basic usage like the number of messages people are sending. If you'd like to disable Parsons metrics, you may do so in Parsons's Settings.
`;
