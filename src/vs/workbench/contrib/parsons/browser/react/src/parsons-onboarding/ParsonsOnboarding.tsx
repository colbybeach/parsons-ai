...
} from "../../../../common/parsonsSettingsTypes.js";
...
import {
	...
	SettingsForProvider,
	ModelDump,
} from "../parsons-settings-tsx/Settings.js";
...
export const ParsonsOnboarding = () => {
...
const VoidIcon = () => {
	...
	return <div ref={divRef} className="@@parsons-bw-icon" />;
};
				...
				{providerNamesOfTab[currentTab].map((providerName) => (
					<div key={providerName} className="w-full max-w-xl mb-10">
						<div className="text-xl mb-2">
							...
							{providerName === "gemini" && (
								<span
									data-tooltip-id="parsons-tooltip-provider-info"
...
// 		title:
// 			div
// 				"How would you like to use Parsons?"
// 		content:
...
const ParsonsOnboardingContent = () => {
	const accessor = useAccessor();
	...
	const lastPagePrevAndNextButtons = (
		<div className="max-w-[600px] w-full mx-auto flex flex-col items-end">
			<div className="flex items-center gap-2">
				...
				<PrimaryActionButton
					onClick={() => {
						parsonsSettingsService.setGlobalSetting("isOnboardingComplete", true);
	...
	const detailedDescOfWantToUseOption: {
		...
		private:
			"Private-hosted so your data never leaves your computer or network. [Visit Parsons](https://parsons.ai) for help setting up at your company.",
		cheap:
				...
				content={
					<div className="flex flex-col items-center gap-8">
						<div className="text-5xl font-light text-center">
							Welcome to Parsons.ai
						</div>

						{/* Slice of Parsons image */}
