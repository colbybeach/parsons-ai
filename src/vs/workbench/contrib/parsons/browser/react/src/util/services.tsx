...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/parsons/common/parsonsSettingsTypes.js'
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js'
import { VoidSettingsState } from '../../../../../../../workbench/contrib/parsons/common/parsonsSettingsService.js'
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js'
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/parsons/common/refreshModelService.js'
...
import { IRefreshModelService } from '../../../../../../../workbench/contrib/parsons/common/refreshModelService.js';
import { IVoidSettingsService } from '../../../../../../../workbench/contrib/parsons/common/parsonsSettingsService.js';
import { IExtensionTransferService } from '../../../../../../../workbench/contrib/parsons/browser/extensionTransferService.js'
...
import { IMetricsService } from '../../../../../../../workbench/contrib/parsons/common/metricsService.js'
...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		parsonsCommandBarService: accessor.get(IParsonsCommandBarService),
		modelService: accessor.get(IModelService),
		mcpService: accessor.get(IMCPService),
	}

	const { settingsStateService, chatThreadsStateService, refreshModelService, themeService, editCodeService, parsonsCommandBarService, modelService, mcpService } = stateServices
	...
	disposables.push(
		parsonsCommandBarService.onDidChangeState(({ uri }) => {
			commandBarURIStateListeners.forEach(l => l(uri));
		})
	)

	disposables.push(
		parsonsCommandBarService.onDidChangeActiveURI(({ uri }) => {
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		IParsonsCommandBarService: accessor.get(IParsonsCommandBarService),
...
export const useAccessor = () => {
	if (!reactAccessor_) {
		throw new Error(`⚠️ Parsons useAccessor was called before _registerServices!`)
	}
