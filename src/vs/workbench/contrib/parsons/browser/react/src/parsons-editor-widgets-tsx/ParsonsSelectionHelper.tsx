...
import { ParsonsSelectionHelperProps } from '../../../../../../contrib/parsons/browser/parsonsSelectionHelperWidget.js';
import { VOID_OPEN_SETTINGS_ACTION_ID } from '../../../parsonsSettingsPane.js';


export const ParsonsSelectionHelperMain = (props: ParsonsSelectionHelperProps) => {
	...
	>
		<ParsonsSelectionHelper {...props} />
	</div>
}



const ParsonsSelectionHelper = ({ rerenderKey }: ParsonsSelectionHelperProps) => {
