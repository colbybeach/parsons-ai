 ...
 * To use:
 * 1. Mount a Tooltip with some id eg id='parsons-tooltip'
 * 2. Add data-tooltip-id="parsons-tooltip" and data-tooltip-content="Your tooltip text" to any element
 */
export const ParsonsTooltip = () => {
	...
	return (
		...
		<>
			<style>
				{`
				#parsons-tooltip, #parsons-tooltip-orange, #parsons-tooltip-green, #parsons-tooltip-ollama-settings, #parsons-tooltip-provider-info {
					font-size: 12px;
					padding: 0px 8px;
					border-radius: 6px;
					z-index: 999999;
				...
				#parsons-tooltip-orange {
					background-color: #F6762A;
					color: white;
				}

				#parsons-tooltip-green {
					background-color: #228B22;
					color: white;
				}

				#parsons-tooltip-ollama-settings, #parsons-tooltip-provider-info {
					background-color: var(--vscode-editor-background);
					color: var(--vscode-input-foreground);
				}
			...
			/>
			<Tooltip
				id="parsons-tooltip-orange"
				border='1px solid rgba(200,200,200,.3)'
				opacity={1}
				delayShow={50}
			/>
			<Tooltip
				id="parsons-tooltip-green"
				border='1px solid rgba(200,200,200,.3)'
				opacity={1}
				delayShow={50}
			/>
			<Tooltip
				id="parsons-tooltip-ollama-settings"
				border='1px solid rgba(100,100,100,.2)'
				opacity={1}
			...
			<Tooltip
				id="parsons-tooltip-provider-info"
				border='1px solid rgba(100,100,100,.2)'
				opacity={1}
				delayShow={50}
