...
export const ParsonsCommandBarMain = ({ uri, editor }: ParsonsCommandBarProps) => {
	const isDark = useIsDark()

	return <div
		className={`@@void-scope ${isDark ? 'dark' : ''}`}
	>
		<ParsonsCommandBar uri={uri} editor={editor} />
	</div>
}
...
export const ParsonsCommandBar = ({ uri, editor }: ParsonsCommandBarProps) => {
