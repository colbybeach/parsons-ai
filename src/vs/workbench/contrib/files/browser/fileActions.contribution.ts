...
import { VOID_OPEN_SETTINGS_ACTION_ID } from '../../parsons/browser/parsonsSettingsPane.js';
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		...
		title: nls.localize({ key: 'openVoid', comment: ['&& denotes a mnemonic'] }, "&&Open Parsons Settings"),
	},
	order: 1
});
