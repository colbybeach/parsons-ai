...
//#region --- Parsons
import './contrib/parsons/browser/parsons.contribution.js'; // Parsons added this
//#endregion
...
// Chat
// Parsons - this is still registered to avoid console errors, we just commented it out in chatParticipant.contribution.ts
