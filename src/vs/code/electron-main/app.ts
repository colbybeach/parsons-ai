...
import { IVoidUpdateService } from '../../workbench/contrib/parsons/common/parsonsUpdateService.js';
import { MetricsMainService } from '../../workbench/contrib/parsons/electron-main/metricsMainService.js';
import { VoidMainUpdateService } from '../../workbench/contrib/parsons/electron-main/parsonsUpdateMainService.js';
import { LLMMessageChannel } from '../../workbench/contrib/parsons/electron-main/sendLLMMessageChannel.js';
import { VoidSCMService } from '../../workbench/contrib/parsons/electron-main/parsonsSCMMainService.js';
import { IVoidSCMService } from '../../workbench/contrib/parsons/common/parsonsSCMTypes.js';
import { MCPChannel } from '../../workbench/contrib/parsons/electron-main/mcpChannel.js';
/**
...
export class CodeApplication extends Disposable {
	...
	private async initServices(machineId: string, sqmId: string, devDeviceId: string, sharedProcessReady: Promise<MessagePortClient>): Promise<IInstantiationService> {
		...
		// Parsons main process services (required for services with a channel for comm between browser and electron-main (node))
	...
	private initChannels(accessor: ServicesAccessor, mainProcessElectronServer: ElectronIPCServer, sharedProcessClient: Promise<MessagePortClient>): void {
		...
		// Parsons - use loggerChannel as reference
